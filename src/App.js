...
const bk_vst_sendEmail = async (e) => {
    ...
    if (locat_fld_bk_vst == '') {
        ...
        if (locat_fld_bk_vst === 'Farukhnagar' || locat_fld_bk_vst === 'Delhi-I' || locat_fld_bk_vst === 'Delhi-II' ||  
        locat_fld_bk_vst === 'Bilaspur-II') {
        ...
        else if (locat_fld_bk_vst === 'Bhayala' || locat_fld_bk_vst === 'Chakan-V' ) {
            ...
            emailjs.sendForm('service_e420df4', 'template_r9mkbyb', e.target, 'SsPYHKCapw4h-xBn_')
                .then((result) => {
        ...
        else if (locat_fld_bk_vst === 'Kothur' || locat_fld_bk_vst === 'Patancheru' || locat_fld_bk_vst === 'Dobbaspet-I' || 
        locat_fld_bk_vst === 'Hosur-I') {
            ...
            emailjs.sendForm('service_e420df4', 'template_a6m74s3', e.target, 'SsPYHKCapw4h-xBn_')
                .then((result) => {
...
//---------------------------------------------------------------------------------------- Book Visit Form code END
    ...
    $(document).ready(function () {
        ...
        if (url === '/parks/bilaspur-i') {
            window.location.href = "/warehousing-park-bilaspur-i";
        }
        if (url === '/parks/bilaspur-ii') {
            window.location.href = "/warehousing-park-bilaspur-ii";
        }
        if (url === '/parks/farukhnagar') {
            window.location.href = "/warehousing-park-farukhnagar";
        }
        ...
        // park_inside_page
        if (url === '/Delhi-NCR' || url === '/Delhi_NCR' || url === '/DELHI_NCR' || url === '/DELHI_NCR' || url === '/DELHI-NCR' || url === '/delhi-ncr' || url === '/delhi_ncr' || url === '/Delhi_ncr') {
            window.location.href = "/warehousing-park-farukhnagar";
        }
        if (url === '/pune' || url === '/PUNE' || url === '/Pune') {
            window.location.href = "/industrial-and-warehousing-park-chakan-ii";
        }
        if (url === '/Ahmedabad' || url === '/AHMEDABAD' || url === '/ahmedabad') {
            window.location.href = "/industrial-and-warehousing-park-bhayala";
        }
        if (url === '/Hyderabad' || url === '/HYDERABAD' || url === '/hyderabad') {
            window.location.href = "/industrial-and-warehousing-park-kothur";
        }
        if (url === '/Bengaluru' || url === '/BENGALURU' || url === '/bengaluru') {
            window.location.href = "/warehousing-park-bilaspur-i";
        }
        ...
        if (url === '/warehousing-park-farukhnagar') {
    ...
    const CustomRoute = () => {
        ...
        if (currentSlug === 'haryana' || currentSlug === 'karnataka' || currentSlug === 'maharashtra' || currentSlug === 'telangana' || currentSlug === 'tamil-nadu' || currentSlug === 'goa' || currentSlug === 'gujarat' || currentSlug === 'delhi' ) {
            return <State_page />;
        } else {
            return <Park_inside_page />;
        }
    };
                ...
                <div className='enquire_from'>
                    ...
                    <form className="row g-3 conversion_form enquire_global_form" ref={form_glb} onSubmit={sendEmail} id='enq_form_bx'>
                        ...
                        <div className="col-xl-6 col-lg-12 col-md-12 col-12 conv_frm_spc">
                            ...
                            <p className='error_msg' id='nm_err_frmglb1'>Letters and space only.</p>
                        </div>
                        <div className="col-xl-6 col-lg-12  col-md-12 col-12 conv_frm_spc">
                        ...
                        <div className="col-12 conv_frm_spc">
                            ...
                            <p className='error_msg' id='msg_err_tellglb1'>Letters and space only.</p>
                        </div>
                ...
                <div className='enquire_from'>
                    ...
                    <form className="row g-3 conversion_form enquire_global_form" ref={bk_vst_form_glb} onSubmit={bk_vst_sendEmail} id='book_vst_form_bx'>
                        ...
                        <div className='col-xl-6 col-lg-12 col-md-12 col-12 conv_frm_spc select_drp'>
                            ...
                            <select className='form-control enq_frm_slct park_dropdown enq_global_form' name='location' id='locat_fld_bk_vst' ref={locationinput_bk_vst} onFocus={handleFocus_bkvst}>
                        ...
                        <div className="col-xl-6 col-lg-12 col-md-12 col-12 conv_frm_spc">
                            ...
                            <input type="date" className="form-control" name="date" id='date_fld_bk_vst' placeholder='DD-MM-YYYY' ref={dateinput_bk_vst} onFocus={handleFocus_bkvst}/>
                        ...
                        <div className="col-xl-6 col-lg-12 col-md-12 col-12 conv_frm_spc">
                            ...
                            <p className='error_msg' id='nm_err_bk_vst1'>Letters and space only.</p>
                        </div>
                        <div className="col-xl-6 col-lg-12  col-md-12 col-12 conv_frm_spc">
                            <label className="form-label">Email Address</label>
                        ...
                        <div className="col-12 conv_frm_spc">
                            ...
                            <p className='error_msg' id='msg_err_bk_vst1'>Letters and space only.</p>
                        </div>
