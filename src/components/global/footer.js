                ...
                <div className='cstm_container'>
                    <div className='row'>
                        <div className='col-lg-4 col-md-3 col-12 col_spc'>
                            ...
                            <a href='/industrial-and-logistics-parks-in-india' className='para ftr_spc'>Parks</a>
                        ...
                        <p className='section_name ftr_sec'>Contact</p>
                            ...
                            <a className='icn_a' href='https://www.instagram.com/horizonindustrialparks/' target='_black'>
                        ...
                        <div className='col-lg-4 col-md-5 col-12'>
                            ...
                            <input className='current_date' type='hidden' name='Date' id='footer_current_date' />
                                ...
                                <p className='error_msg_broch' id='nm_err_b1'>Letters and space only.</p>
                    ...
                    <div className='row crd_row footer_bottom'>
                        <div className='col-lg-9 col-md-8 col-12 btm_para'>
                            <p className='para cstm_para'>2024 Horizon Industrial Parks. All Rights Reserved.</p>
                        </div>
