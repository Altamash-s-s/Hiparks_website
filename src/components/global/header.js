                                                        ...
                                                        <div className="col-lg-2 col-6 over_flow">
                                                            <div className="col-megamenu menu_animate_box animi_bx2">
                                                                ...
                                                                <ul className="list-unstyled">
                                                                    ...
                                                                    <li><a href="/warehousing-park-koka">Koka</a></li>
                                                                </ul>
                                                ...
                                                <div className="row row_border">
                                                    ...
                                                    <div className="col-lg-4 col-6 over_flow">
                                                        <div className="col-megamenu menu_animate_box animi_bx1 park_menu_col1">
                                                            ...
                                                            <img src={require('../../assets/img/solution_menu.png')}></img>
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-4 col-6 over_flow">
                                                        <div className="col-megamenu menu_animate_box animi_bx2">
                                        ...
                                        <li className="nav-item dropdown has-megamenu menu_link explore_drp">
                                            ...
                                            <div className="dropdown-menu megamenu" role="menu">
                                                ...
                                                <div className="row row_border">
                                                    ...
                                                    <div className="col-lg-4 col-6 over_flow">
                                                        <div className="col-megamenu menu_animate_box animi_bx1 park_menu_col1">
                                                            <img src={require('../../assets/img/explore_menu.png')}></img>
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-4 col-6 over_flow">
                                                        <div className="col-megamenu menu_animate_box animi_bx2">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <ul className='lv_3ul'>
                                            ...
                                            <li><a className='lv_3' href="/warehousing-park-koka">Koka</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    {/*---- State */}
                                    <li>
                                        <a className='lv_2' href="#">View by State</a>
                                        <ul className='lv_3ul'>
                                            
                                            <li><a className='lv_3' href="/delhi">Delhi</a></li>
                                            <li><a className='lv_3' href="/haryana">Haryana</a></li>
                                            <li><a className='lv_3' href="/goa">Goa</a></li>
                                            <li><a className='lv_3' href="/maharashtra">Maharashtra</a></li>
                                            <li><a className='lv_3' href="/gujarat">Gujarat</a></li>
                                            <li><a className='lv_3' href="/tamil-nadu">Tamil Nadu</a></li>
                                            <li><a className='lv_3' href="/telangana">Telangana</a></li>
                                            <li><a className='lv_3' href="/karnataka">Karnataka</a></li>
