                            ...
                            <div className="tab-content">
                                ...
                                <div id="home" className="container tab-pane active fade show client_logo_tab"><br />
                                    <div className='img_row_1'>
                                        ...
                                        <div className='img_col1 non_charcol_img'><img className='' src={require('../../assets/img/svg/Auto/SVG/oetiker.svg').default} ></img></div>
                                        <div className='img_col1 charcol_img'><img className='' src={require('../../assets/img/svg/Auto/SVG/oetiker1.svg').default} ></img></div>
                                    {/* </div>
                                    <div className='img_row_2'> */}
                                        <div className='inside_col'>
                                            ...
                                            <div className='img_col1 lumax_logo'><img className='' src={require('../../assets/img/svg/Auto/SVG/lumax_logo.svg').default} ></img></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="menu1" className="container tab-pane fade client_logo_tab"><br />
                                    <div className='img_row_1'>
                                        ...
                                        <div className='img_col1 non_charcol_img'><img className='' src={require('../../assets/img/svg/Ecommerce/SVG/blinkit.svg').default} ></img></div>
                                        <div className='img_col1 non_charcol_img'><img className='' src={require('../../assets/img/svg/Ecommerce/SVG/dealshare.svg').default} ></img></div>
                                        <div className='img_col1 non_charcol_img'><img className='' src={require('../../assets/img/svg/Ecommerce/SVG/decathlon.svg').default} ></img></div>
                                        <div className='img_col1 non_charcol_img'><img className='' src={require('../../assets/img/svg/Ecommerce/SVG/firstcry.svg').default} ></img></div>

                                        <div className='img_col1 charcol_img'><img className='' src={require('../../assets/img/svg/Ecommerce/SVG/blinkit1.svg').default} ></img></div>
                                        <div className='img_col1 charcol_img'><img className='' src={require('../../assets/img/svg/Ecommerce/SVG/dealshare1.svg').default} ></img></div>
                                        <div className='img_col1 charcol_img'><img className='' src={require('../../assets/img/svg/Ecommerce/SVG/decathlon1.svg').default} ></img></div>
                                        <div className='img_col1 charcol_img'><img className='' src={require('../../assets/img/svg/Ecommerce/SVG/firstcry1.svg').default} ></img></div>
                                    {/* </div>
                                    <div className='img_row_2'> */}
                                    <div className='inside_col'>
                                        ...
                                        <div className='img_col1 non_charcol_img'><img className='' src={require('../../assets/img/svg/Ecommerce/SVG/myntra.svg').default} ></img></div>
                                        <div className='img_col1 charcol_img'><img className='' src={require('../../assets/img/svg/Ecommerce/SVG/myntra1.svg').default} ></img></div>
                                ...
                                <div id="menu2" className="container tab-pane fade client_logo_tab"><br />
                                    <div className='img_row_1'>
                                        <div className='inside_col'>
                                            <div className='img_col1'><img src={require('../../assets/img/svg/Engineering/SVG/Frame 2Engineering.svg').default} ></img></div>
                                            <div className='img_col1'><img src={require('../../assets/img/svg/Engineering/SVG/Frame 3Engineering.svg').default} ></img></div>
                                            <div className='img_col1'><img src={require('../../assets/img/svg/Engineering/SVG/Frame 4Engineering.svg').default} ></img></div>
                                            <div className='img_col1'><img src={require('../../assets/img/svg/Engineering/SVG/Frame 6Engineering.svg').default} ></img></div>
                                        </div>
                                    </div>
                                ...
                                <div id="menu3" className="container tab-pane fade client_logo_tab"><br />
                                    ...
                                    <div className='img_row_2'> */}
                                        ...
                                        <div className='inside_col'>
                                            ...
                                            <div className='img_col2 safe_express non_charcol_img'><img className='' src={require('../../assets/img/svg/Logistics/SVG/safe_express.svg').default} ></img></div>
                                            <div className='img_col2 safe_express charcol_img'><img className='' src={require('../../assets/img/svg/Logistics/SVG/safe_express1.svg').default} ></img></div>
                                        </div>
                                ...
                                <div id="menu4" className="container tab-pane fade client_logo_tab"><br />
                                    <div className='img_row_1'>
                                        <div className='img_col1 non_charcol_img'><img className='' src={require('../../assets/img/svg/Oil&Energy/SVG/wacker.svg').default} ></img></div>
                                        <div className='img_col1 charcol_img'><img className='' src={require('../../assets/img/svg/Oil&Energy/SVG/wacker1.svg').default} ></img></div>
                                        ...
                                        <div className='img_col1 non_charcol_img'><img className='' src={require('../../assets/img/svg/Oil&Energy/SVG/SMA.svg').default}></img></div>
                                        <div className='img_col1 charcol_img'><img className='' src={require('../../assets/img/svg/Oil&Energy/SVG/SMA1.svg').default}></img></div>
                                    ...
                                    <div className='inside_col'>
                                        ...
                                        <div className='img_col1 non_charcol_img'><img className='' src={require('../../assets/img/svg/Oil&Energy/SVG/lubrikote.svg').default} ></img></div>
                                        <div className='img_col1 charcol_img'><img className='' src={require('../../assets/img/svg/Oil&Energy/SVG/lubrikote1.svg').default} ></img></div>
                                      
                                        <div className='img_col2 non_charcol_img'><img className='' src={require('../../assets/img/svg/Oil&Energy/SVG/fosroc.svg').default} ></img></div>
                                        <div className='img_col2 charcol_img'><img className='' src={require('../../assets/img/svg/Oil&Energy/SVG/fosroc1.svg').default} ></img></div>
                                ...
                                <div id="menu5" className="container tab-pane fade client_logo_tab"><br />
                                    <div className='img_row_1'>
                                        ...
                                        <div className='img_col1'><img className='' src={require('../../assets/img/svg/others/SVG/thermo_fisher.svg').default} ></img></div>
                                            ...
                                            <div className='img_col1 non_charcol_img'><img className='' src={require('../../assets/img/svg/others/SVG/adtya_birla_group.svg').default} ></img></div> 
                                            <div className='img_col1 charcol_img'><img className='' src={require('../../assets/img/svg/others/SVG/adtya_birla_group1.svg').default} ></img></div> 
